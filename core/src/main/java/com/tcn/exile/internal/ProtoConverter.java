...
public final class ProtoConverter {
  ...
  public static CallType toCallType(tcnapi.exile.types.v3.CallType ct) {
    return switch (ct) {
  ...
  public static AgentState toAgentState(tcnapi.exile.types.v3.AgentState as) {
    try {
  ...
  public static tcnapi.exile.types.v3.AgentState fromAgentState(AgentState as) {
    try {
      return tcnapi.exile.types.v3.AgentState.valueOf("AGENT_STATE_" + as.name());
    } catch (IllegalArgumentException e) {
      return tcnapi.exile.types.v3.AgentState.AGENT_STATE_UNSPECIFIED;
    }
  }

  // ---- Core types ----

  public static Pool toPool(tcnapi.exile.types.v3.Pool p) {
    return new Pool(
        p.getPoolId(),
        p.getDescription(),
        switch (p.getStatus()) {
  ...
  public static tcnapi.exile.types.v3.Pool fromPool(Pool p) {
    return tcnapi.exile.types.v3.Pool.newBuilder()
        .setPoolId(p.poolId())
        .setDescription(p.description())
        .setStatus(
            switch (p.status()) {
              case READY -> tcnapi.exile.types.v3.Pool.PoolStatus.POOL_STATUS_READY;
              case NOT_READY -> tcnapi.exile.types.v3.Pool.PoolStatus.POOL_STATUS_NOT_READY;
              case BUSY -> tcnapi.exile.types.v3.Pool.PoolStatus.POOL_STATUS_BUSY;
              default -> tcnapi.exile.types.v3.Pool.PoolStatus.POOL_STATUS_UNSPECIFIED;
            })
  ...
  public static Field toField(tcnapi.exile.types.v3.Field f) {
    return new Field(f.getFieldName(), f.getFieldValue(), f.getPoolId(), f.getRecordId());
  }

  public static tcnapi.exile.types.v3.Field fromField(Field f) {
    return tcnapi.exile.types.v3.Field.newBuilder()
  ...
  public static Filter toFilter(tcnapi.exile.types.v3.Filter f) {
    return new Filter(
        f.getField(),
  ...
  public static tcnapi.exile.types.v3.Filter fromFilter(Filter f) {
    return tcnapi.exile.types.v3.Filter.newBuilder()
        .setField(f.field())
        .setOperator(
            switch (f.operator()) {
              case EQUAL -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_EQUAL;
              case NOT_EQUAL -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_NOT_EQUAL;
              case CONTAINS -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_CONTAINS;
              case GREATER_THAN -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_GREATER_THAN;
              case LESS_THAN -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_LESS_THAN;
              case IN -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_IN;
              case EXISTS -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_EXISTS;
              default -> tcnapi.exile.types.v3.Filter.Operator.OPERATOR_UNSPECIFIED;
            })
        .setValue(f.value())
        .build();
  }

  public static List<TaskData> toTaskData(List<tcnapi.exile.types.v3.TaskData> list) {
    return list.stream()
  ...
  public static Agent toAgent(tcnapi.exile.types.v3.Agent a) {
  ...
  public static Skill toSkill(tcnapi.exile.types.v3.Skill s) {
    return new Skill(
        s.getSkillId(),
        s.getName(),
        s.getDescription(),
  ...
  public static AgentCallEvent toAgentCallEvent(tcnapi.exile.types.v3.AgentCall ac) {
  ...
  public static AgentResponseEvent toAgentResponseEvent(tcnapi.exile.types.v3.AgentResponse ar) {
  ...
  public static CallRecordingEvent toCallRecordingEvent(tcnapi.exile.types.v3.CallRecording cr) {
  ...
  public static TaskEvent toTaskEvent(tcnapi.exile.types.v3.Task t) {
