...
public class AdminRoutes {
     ...
     * @param reloadHandler  Optional callback when new config is loaded (null if not supported)
     */
    ...
    @OpenApi(
        ...
        tags = {"Admin"},
        responses = @OpenApiResponse(status = "200", content = @OpenApiContent(from = StatusResponse.class))
    )
    private static void getStatus(Context ctx) {
        ...
        StatusResponse response = new StatusResponse(
            ...
            tenantStatus != null && tenantStatus.jobStreamConnected(),
    ...
    @OpenApi(
        path = "/api/admin/logs",
        methods = HttpMethod.GET,
        summary = "Get recent log messages",
        tags = {"Admin"},
        queryParams = @OpenApiParam(name = "limit", type = Integer.class, description = "Max logs to return"),
    ...
    @OpenApi(
        ...
        summary = "Load new configuration",
        tags = {"Admin"},
        requestBody = @OpenApiRequestBody(content = @OpenApiContent(from = ConfigRequest.class)),
        responses = {
